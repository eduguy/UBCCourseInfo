  ...
  chrome.runtime.sendMessage({
    ...
    if (responseText != 'ERROR') {
      ...
      if (!document.getElementById('CourseInfoDivID')) {
        ...
        div.innerHTML = "THIS INFORMATION IS FROM UBCGRADES API AND THE UBC COURSE INFO EXTENSION.<br><br>The course average for " + year + ((result) ? ' was '+ result + '%' : ' is not available') + ".";
        console.log(result);
